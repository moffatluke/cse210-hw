public abstract class Activity
{
    ...
    //GetType().Name is used to return the name of the class at runtime
    //GetType is a built in function
    //.Name is built-in aswell. It returns the name as a string.
    //GetType() is method called on a object
    //.Name is a property on what GetType() returns.
